...
Pour rappel, l'utilisation de SDK tiers dans les applications mobiles représente un risque important de collecte de données non maîtrisée comme Defensive Lab Agency a pu le montrer lors de ses [analyses pour le Wall Street Journal début 2019](https://defensive-lab.agency/2019/02/retour-sur-nos-analyses-dapplications-mobiles-utilisant-facebook-realisees-pour-le-wall-street-journal/).
